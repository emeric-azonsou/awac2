...
describe('timeRemaining', () => {
  it('décompose la durée restante en jours, heures, minutes, secondes', () => {
    ...
    const now = at('2026-08-12T18:47:34+01:00')
  ...
  it('tombe à zéro exactement à la seconde de clôture', () => {
    expect(timeRemaining(at('2026-08-19T23:59:59+01:00'))).toEqual({
      days: 0,
      hours: 0,
      minutes: 0,
      seconds: 0,
  ...
  it('compte une seconde restante à une seconde de la fin', () => {
    const result = timeRemaining(at('2026-08-19T23:59:58+01:00'))
  ...
  it("n'est pas affecté par le fuseau de la machine : la clôture est en heure du Bénin", () => {
    ...
    expect(timeRemaining(at('2026-08-19T22:59:59Z')).expired).toBe(true)
    expect(timeRemaining(at('2026-08-19T22:59:58Z')).expired).toBe(false)
  })
})

describe('isVotingClosed', () => {
  it('est faux avant la clôture et vrai après', () => {
    expect(isVotingClosed(at('2026-08-19T23:59:58+01:00'))).toBe(false)
    expect(isVotingClosed(at('2026-08-20T00:00:00+01:00'))).toBe(true)
  })
})

describe('VOTE_DEADLINE', () => {
  it('est le 19 août 2026 à 23h59:59 heure du Bénin', () => {
    expect(VOTE_DEADLINE.toISOString()).toBe('2026-08-19T22:59:59.000Z')
  })
})
