// Vérification du login admin contre la table `admins` (Neon), avec
// anti-bruteforce en mémoire par couple IP+email. Réponse 401 identique que
// l'email existe ou non (pas d'énumération de comptes).
