import { useCandidateShare } from '../hooks/useCandidateShare'
import { getFirstName } from '../utils/candidateShare'
import './CandidateShareCompact.css'
    ...
    >
      {canNativeShare ? (
        <button
          ...
          className="share-dot text-gray-700"
      ...
      <a
        ...
        className="share-dot text-[#128C7E]"
      >
      ...
      <a
        ...
        className="share-dot text-[#0B5FCC]"
      >
        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button
        ...
        aria-live="polite"
        className={`share-dot ${copied ? 'text-awac-primary' : 'text-gray-700'}`}
